<?php
/**
 * SapiV1BswapRemoveLiquidityPreviewGet200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SapiV1BswapRemoveLiquidityPreviewGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1BswapRemoveLiquidityPreviewGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_bswap_removeLiquidityPreview_get_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quote_amt', $data ?? [], null);
        $this->setIfExists('base_amt', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['quote_amt'] === null) {
            $invalidProperties[] = "'quote_amt' can't be null";
        }
        if ($this->container['base_amt'] === null) {
            $invalidProperties[] = "'base_amt' can't be null";
        }
     ...
     * @return int
     */
    public function getQuoteAmt()
    {
        return $this->container['quote_amt'];
    }

    /**
     * Sets quote_amt
     *
     * @param int $quote_amt quote_amt
     *
     * @return self
     */
    public function setQuoteAmt($quote_amt)
    {
        if (is_null($quote_amt)) {
            throw new \InvalidArgumentException('non-nullable quote_amt cannot be null');
        }
        $this->container['quote_amt'] = $quote_amt;
    ...
    {
        return $this->container['base_amt'];
    }

    /**
     * Sets base_amt
     *
     * @param int $base_amt base_amt
     *
     * @return self
     */
    public function setBaseAmt($base_amt)
    {
        if (is_null($base_amt)) {
            throw new \InvalidArgumentException('non-nullable base_amt cannot be null');
        }
        $this->container['base_amt'] = $base_amt;
