...
class OrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'iceberg_qty' => 'setIcebergQty',
        'time' => 'setTime',
        'update_time' => 'setUpdateTime',
        'is_working' => 'setIsWorking',
        'orig_quote_order_qty' => 'setOrigQuoteOrderQty'
    ];
    ...
    protected static $getters = [
        ...
        'iceberg_qty' => 'getIcebergQty',
        'time' => 'getTime',
        'update_time' => 'getUpdateTime',
        'is_working' => 'getIsWorking',
        'orig_quote_order_qty' => 'getOrigQuoteOrderQty'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('iceberg_qty', $data ?? [], null);
        $this->setIfExists('time', $data ?? [], null);
        $this->setIfExists('update_time', $data ?? [], null);
        $this->setIfExists('is_working', $data ?? [], null);
        $this->setIfExists('orig_quote_order_qty', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['iceberg_qty'] === null) {
            $invalidProperties[] = "'iceberg_qty' can't be null";
        }
        ...
        if ($this->container['orig_quote_order_qty'] === null) {
            $invalidProperties[] = "'orig_quote_order_qty' can't be null";
        }
     ...
     * Sets order_list_id
     *
     * @param int $order_list_id Unless OCO, value will be -1
     *
     * @return self
     */
     ...
     * Sets stop_price
     *
     * @param string $stop_price stop_price
     *
     * @return self
     */
    ...
    {
        return $this->container['iceberg_qty'];
    }

    /**
     * Sets iceberg_qty
     *
     * @param string $iceberg_qty iceberg_qty
     *
     * @return self
     */
    public function setIcebergQty($iceberg_qty)
    {
        if (is_null($iceberg_qty)) {
            throw new \InvalidArgumentException('non-nullable iceberg_qty cannot be null');
        }
        $this->container['iceberg_qty'] = $iceberg_qty;
     ...
     * Sets is_working
     *
     * @param bool $is_working is_working
     *
     * @return self
     */
    ...
    /**
     * Gets orig_quote_order_qty
     *
     * @return string
     */
    public function getOrigQuoteOrderQty()
    {
        return $this->container['orig_quote_order_qty'];
    }

    /**
     * Sets orig_quote_order_qty
     *
     * @param string $orig_quote_order_qty orig_quote_order_qty
     *
     * @return self
     */
    public function setOrigQuoteOrderQty($orig_quote_order_qty)
    {
        if (is_null($orig_quote_order_qty)) {
            throw new \InvalidArgumentException('non-nullable orig_quote_order_qty cannot be null');
        }
        $this->container['orig_quote_order_qty'] = $orig_quote_order_qty;
