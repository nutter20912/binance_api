...
/**
 * SapiV1MarginOpenOrdersDelete200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1MarginOpenOrdersDelete200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_margin_openOrders_delete_200_response_inner';
    ...
    protected static $openAPITypes = [
        ...
        'orders' => '\OpenAPI\Client\Model\MarginOcoOrderOrdersInner[]',
        'order_reports' => '\OpenAPI\Client\Model\MarginOcoOrderOrderReportsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'orig_client_order_id' => 'setOrigClientOrderId',
        'order_id' => 'setOrderId',
    ...
    protected static $getters = [
        ...
        'orig_client_order_id' => 'getOrigClientOrderId',
        'order_id' => 'getOrderId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('orig_client_order_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['orig_client_order_id'] === null) {
            $invalidProperties[] = "'orig_client_order_id' can't be null";
        }
    ...
    /**
     * Gets orig_client_order_id
     *
     * @return string
     */
    public function getOrigClientOrderId()
    {
        return $this->container['orig_client_order_id'];
    }

    /**
     * Sets orig_client_order_id
     *
     * @param string $orig_client_order_id orig_client_order_id
     *
     * @return self
     */
    public function setOrigClientOrderId($orig_client_order_id)
    {
        if (is_null($orig_client_order_id)) {
            throw new \InvalidArgumentException('non-nullable orig_client_order_id cannot be null');
        }
        $this->container['orig_client_order_id'] = $orig_client_order_id;
     ...
     * Gets orders
     *
     * @return \OpenAPI\Client\Model\MarginOcoOrderOrdersInner[]
     */
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Model\MarginOcoOrderOrdersInner[] $orders orders
     *
     * @return self
     */
     ...
     * Gets order_reports
     *
     * @return \OpenAPI\Client\Model\MarginOcoOrderOrderReportsInner[]
     */
     ...
     * Sets order_reports
     *
     * @param \OpenAPI\Client\Model\MarginOcoOrderOrderReportsInner[] $order_reports order_reports
     *
     * @return self
     */
