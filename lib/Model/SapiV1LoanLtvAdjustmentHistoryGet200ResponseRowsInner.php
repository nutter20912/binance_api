...
/**
 * SapiV1LoanLtvAdjustmentHistoryGet200ResponseRowsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1LoanLtvAdjustmentHistoryGet200ResponseRowsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_loan_ltv_adjustment_history_get_200_response_rows_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pre_ltv', $data ?? [], null);
        $this->setIfExists('after_ltv', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pre_ltv'] === null) {
            $invalidProperties[] = "'pre_ltv' can't be null";
        }
        if ($this->container['after_ltv'] === null) {
            $invalidProperties[] = "'after_ltv' can't be null";
        }
        if ($this->container['adjust_time'] === null) {
            $invalidProperties[] = "'adjust_time' can't be null";
        }
     ...
     * @return string
     */
    public function getPreLtv()
    {
        return $this->container['pre_ltv'];
    }

    /**
     * Sets pre_ltv
     *
     * @param string $pre_ltv pre_ltv
     *
     * @return self
     */
    public function setPreLtv($pre_ltv)
    {
        if (is_null($pre_ltv)) {
            throw new \InvalidArgumentException('non-nullable pre_ltv cannot be null');
        }
        $this->container['pre_ltv'] = $pre_ltv;
     ...
     * Sets after_ltv
     *
     * @param string $after_ltv after_ltv
     *
     * @return self
     */
    public function setAfterLtv($after_ltv)
    {
        if (is_null($after_ltv)) {
            throw new \InvalidArgumentException('non-nullable after_ltv cannot be null');
        }
     ...
     * Sets adjust_time
     *
     * @param int $adjust_time adjust_time
     *
     * @return self
     */
