...
/**
 * SapiV1MarginMaxTransferableGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1MarginMaxTransferableGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_margin_maxTransferable_get_200_response';
    ...
    */
     ...
     * Sets amount
     *
     * @param string $amount Account's currently max borrowable amount with sufficient system availability
     *
     * @return self
     */
     ...
     * Sets borrow_limit
     *
     * @param string $borrow_limit Max borrowable amount limited by the account level
     *
     * @return self
     */
