...
/**
 * SapiV1AlgoFuturesSubOrdersGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1AlgoFuturesSubOrdersGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_algo_futures_subOrders_get_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'executed_qty' => 'string',
        'executed_amt' => 'string',
        'sub_orders' => '\OpenAPI\Client\Model\SapiV1AlgoFuturesSubOrdersGet200ResponseSubOrdersInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sub_orders', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sub_orders'] === null) {
            $invalidProperties[] = "'sub_orders' can't be null";
        }
     ...
     * Gets sub_orders
     *
     * @return \OpenAPI\Client\Model\SapiV1AlgoFuturesSubOrdersGet200ResponseSubOrdersInner[]
     */
     ...
     * Sets sub_orders
     *
     * @param \OpenAPI\Client\Model\SapiV1AlgoFuturesSubOrdersGet200ResponseSubOrdersInner[] $sub_orders sub_orders
     *
     * @return self
     */
    public function setSubOrders($sub_orders)
    {
        if (is_null($sub_orders)) {
            throw new \InvalidArgumentException('non-nullable sub_orders cannot be null');
        }
