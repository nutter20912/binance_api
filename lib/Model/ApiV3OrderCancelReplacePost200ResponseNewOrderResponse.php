...
/**
 * ApiV3OrderCancelReplacePost200ResponseNewOrderResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrderCancelReplacePost200ResponseNewOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v3_order_cancelReplace_post_200_response_newOrderResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['fills']) > 0)) {
            $invalidProperties[] = "invalid value for 'fills', number of items must be less than or equal to 0.";
        }
    ...
    public function setFills($fills)
    {
        ...
        if ((count($fills) > 0)) {
            throw new \InvalidArgumentException('invalid value for $fills when calling ApiV3OrderCancelReplacePost200ResponseNewOrderResponse., number of items must be less than or equal to 0.');
        }
