...
/**
 * SapiV1FuturesTransferGet200ResponseRowsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SapiV1FuturesTransferGet200ResponseRowsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_sapi_v1_futures_transfer_get_200_response_rows_inner';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status one of PENDING (pending to execution), CONFIRMED (successfully transfered), FAILED (execution failed, nothing happened to your account);
     *
     * @return self
     */
